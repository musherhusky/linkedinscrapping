# Capability: Target Terms Scraping

## Purpose

Let users track free-text search terms (in addition to companies and people), scraping LinkedIn posts that mention those terms via a dedicated Apify actor, filtering out irrelevant backfill results, and feeding matches into the same dedupe/dispatch pipeline used for company and person posts.
